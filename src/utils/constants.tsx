...
export const UPDATE_SCHEDULE_SUCCESS = '[APP] UPDATE_SCHEDULE_SUCCESS';
export const UPDATE_SCHEDULE_FAILED = '[APP] UPDATE_SCHEDULE_FAILED';
...
export const LOAD_GROUPS_FAILED = '[APP] LOAD_GROUPS_FAILED';
...
export const SET_USER_GROUP_SUCCESS = '[USER] SET_USER_GROUP_SUCCESS';
export const SET_USER_GROUP_FAILED = '[USER] SET_USER_GROUP_FAILED';
